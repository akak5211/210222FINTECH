                ...
                if(err){
                    ...
                    if(transactionListResuult.rsp_code === "A0000"){
                        ...
                        var option = {
                            ...
                            headers : {
                              Authorization : "Bearer " + "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJNMjAyMTExNTk1Iiwic2NvcGUiOlsib29iIl0sImlzcyI6Imh0dHBzOi8vd3d3Lm9wZW5iYW5raW5nLm9yLmtyIiwiZXhwIjoxNjIyMDg1NjUzLCJqdGkiOiIwODNmNWNlMS0zYzgyLTQ1NWItOTdhNS0yZjQ2NDUwMmQ4Y2MifQ.zScQsGyGS7T4sxOH9oflOCsKCkAwlfLIv0__QWFaAQk"
                            },
                            //get 요청을 보낼때 데이터는 qs, post 에 form, json 입력가능
                            json : {
                              "cntr_account_type": "N",
                              "cntr_account_num": "123123123123",
                              "wd_pass_phrase": "NONE",
